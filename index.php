...
$pages = [
    ...
    'registration' => [
        ...
        'description' => 'Capture shop details, mobile money references, and TIN data in one place, while still allowing demo onboarding when a live TIN is not available yet.',
    ],
    'login' => [
        'label' => 'Login',
        'eyebrow' => 'Access portal',
        'title' => 'Sign in with the seeded demo accounts',
        'description' => 'Use the seeded government, lender, and field-agent accounts so each role opens the right workspace.',
        'nav' => false,
    ],
    'workspace' => [
        'label' => 'Workspace',
        ...
        'description' => 'After sign-in, each role gets a focused workspace with the most relevant businesses, actions, and next steps for the MVP.',
        'nav' => false,
    ],
    'credit' => [
        'label' => 'Credit Engine',
